...
"""
view for info list and details
"""
...
"""
view for event that related to the group
"""
        ...
        if 'group' in request.data and 'user' in request.data:
            try:
                ...
                member = Member.objects.create(
                    group=group, user=user, admin=False)
